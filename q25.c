...
/**
Output:
Parent is waiting for Child 2 (PID: 4765)
Child 1 (PID: 4764) is running
Child 2 (PID: 4765) is running
Child 3 (PID: 4766) is running
Child 2 (PID: 4765) has finished. Parent continues.
All children have finished. Parent process (PID: 4763) exiting.
**/
